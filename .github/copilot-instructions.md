...
- `entity/` - Base entity class (`IntentsityEntity`)
...
- All entities inherit: `(PlatformEntity, IntentsityEntity)` - order matters for MRO
...
- Adjust log level: `custom_components.intentsity: debug` in `config/configuration.yaml`
