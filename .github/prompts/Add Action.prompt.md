...
**File:** `custom_components/intentsity/services.yaml`
...
Create `custom_components/intentsity/service_actions/[action_name].py`:

```python
"""[Action name] service action for Intentsity."""
...
**File:** `custom_components/intentsity/__init__.py`
...
**File:** `custom_components/intentsity/const.py`
...
3. Find service action: `intentsity.[action_name]`
...
- **Domain:** `intentsity`
- **Service actions directory:** `custom_components/intentsity/service_actions/` (preferred) or `actions/`
- **Service actions definition:** `custom_components/intentsity/services.yaml` (legacy filename)
- **Icons:** `custom_components/intentsity/icons.json` under `services` key (legacy)
- **Translations:** `custom_components/intentsity/translations/*.json` under `services` key (legacy)
