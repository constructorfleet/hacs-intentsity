...
- Create new sensor file in `custom_components/intentsity/sensor/`
- Inherit from `IntentsityEntity` and `SensorEntity`
...
```python
"""[Sensor description] for Intentsity."""
...
class Intentsity[SensorName]Sensor(
    IntentsityEntity,
    SensorEntity,
):
...
- Entity: `custom_components/intentsity/sensor/[sensor_name].py`
- Platform: `custom_components/intentsity/sensor/__init__.py`
- Translations: `custom_components/intentsity/translations/*.json`
