...
- Inherit from `IntentsityEntity` and platform base class
...
- Entity: `custom_components/intentsity/[platform]/[entity_name].py`
- Platform: `custom_components/intentsity/[platform]/__init__.py`
