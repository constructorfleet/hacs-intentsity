...
**Directory:** `custom_components/intentsity/[platform]/`
...
```python
"""[Platform] platform for Intentsity."""
...
from .entity import IntentsityEntity
from .[entity_file] import Intentsity[EntityName]
...
async def async_setup_entry(
    ...
    coordinator: IntentsityDataUpdateCoordinator = hass.data[DOMAIN][
        entry.entry_id
    ]

    async_add_entities(
        [
            Intentsity[EntityName](coordinator, entry),
...
```python
"""[Entity description] for Intentsity."""
...
Add platform to `custom_components/intentsity/manifest.json`:
...
- [ ] Entity class inherits from both `IntentsityEntity` and platform class
...
- **Domain:** `intentsity`
- **Class prefix:** `Intentsity`
- **Base entity:** `IntentsityEntity` in `entity/base.py`
- **Coordinator:** `IntentsityDataUpdateCoordinator`
