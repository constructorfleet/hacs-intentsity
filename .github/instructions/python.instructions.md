...
- Files: `snake_case.py`
- Classes: `PascalCase` prefixed with `Intentsity`
...
- Inherit from both platform entity and `IntentsityEntity` (order matters)
...
from custom_components.intentsity.sensor import async_setup_entry
...
**Config entry data:** `entry_data: IntentsityData = hass.data[DOMAIN][entry.entry_id]`
