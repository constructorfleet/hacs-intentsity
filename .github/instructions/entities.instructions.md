...
- **`entity/`** - Base entity classes (inherit `IntentsityEntity` from `entity/base.py`)
...
**MUST inherit from:** `(PlatformEntity, IntentsityEntity)` - order matters for MRO
...
**Imports pattern:** `from homeassistant.components.PLATFORM import PlatformEntity, PlatformEntityDescription` + `from ..entity import IntentsityEntity`
