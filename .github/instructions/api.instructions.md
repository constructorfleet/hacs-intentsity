...
- `IntentsityApiClientError` (Base)
- `IntentsityApiClientCommunicationError` (Network, timeout, HTTP errors)
- `IntentsityApiClientAuthenticationError` (401, 403, invalid credentials)
