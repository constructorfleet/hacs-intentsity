...
from custom_components.intentsity.config_flow_handler.schemas import (
    get_reauth_schema,
...
ERROR_MAP = {
    "IntentsityApiClientAuthenticationError": "auth",
    "IntentsityApiClientCommunicationError": "connection",
}
