...
def _normalize_corrected_messages(
    ...
    for message in messages:
        ...
        if is_tool_result:
            ...
            if last_assistant_tool_call_ids:
                if tool_call_id not in last_assistant_tool_call_ids:
        ...
        if has_tool_calls:
            ...
            last_assistant_tool_call_ids = [
                call["tool_call_id"] for call in tool_calls_payload
            ]
        ...
        output.append(entry)
        if role == "assistant" and not tool_calls_payload:
            last_assistant_tool_call_ids = []
