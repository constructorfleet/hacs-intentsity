"""Target humidity number for intentsity."""

from __future__ import annotations

from typing import TYPE_CHECKING

from custom_components.intentsity.api import IntentsityApiClientError
from custom_components.intentsity.const import LOGGER
from custom_components.intentsity.entity import IntentsityEntity
from homeassistant.components.number import NumberDeviceClass, NumberEntity, NumberEntityDescription, NumberMode
from homeassistant.const import PERCENTAGE
from homeassistant.exceptions import HomeAssistantError

if TYPE_CHECKING:
    from custom_components.intentsity.coordinator import IntentsityDataUpdateCoordinator
...
class IntentsityHumidityNumber(NumberEntity, IntentsityEntity):
